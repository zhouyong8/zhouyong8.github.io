...
$(function(){
	...
	if(tel_str.indexOf("?tel=") > 0 ){   //地址栏有电话
        ...
        $.ajax({
            type:"post",
            url:"MAjax.ashx?action=CheckSalesmanPhone&t=" + Math.random(),
            data:"Phone=" + phone,
            beforeSend:function() {},
...
function footerKefu() {     //底部客服
    var sc = $(".social_nav2");
    $("http://www.bossfq.com/mobile_files/.social_nav2 .btn").bind('click', function () {
        sc.find(".social2").hide();
        sc.show();
        $(this).hide();
        $("http://www.bossfq.com/mobile_files/.social_nav2 .btn2").css('left', '0').show();
    })
    $("http://www.bossfq.com/mobile_files/.social_nav2 .btn2").bind('click', function () {
        sc.find(".social2").show();
        sc.show();
        $(this).hide();
        $("http://www.bossfq.com/mobile_files/.social_nav2 .btn").show();
    });
  
    $(".social_nav3").attr('id','akb_slide');
	$('.social_nav3 .social3').bind('touchmove',function() {	
		jelle('akb_slide').animate({left:'-288px'},200,function(){$('http://www.bossfq.com/mobile_files/.social_nav3 .btn').hide();$("http://www.bossfq.com/mobile_files/.social_nav3 .btn2").show();});
		return false;
	});
    $('http://www.bossfq.com/mobile_files/.social_nav3 .btn').bind('click touchmove',function() {	
		jelle('akb_slide').animate({left:'-288px'},200,function(){$('http://www.bossfq.com/mobile_files/.social_nav3 .btn').hide();$("http://www.bossfq.com/mobile_files/.social_nav3 .btn2").show();});
		return false;
	});
	$("http://www.bossfq.com/mobile_files/.social_nav3 .btn2").bind('click touchmove',function() {
		jelle('akb_slide').animate({left:'0px'},200,function(){$("http://www.bossfq.com/mobile_files/.social_nav3 .btn2").hide();$('http://www.bossfq.com/mobile_files/.social_nav3 .btn').show();});
		return false;
	});
...
function scrollBar() {     //滚动JS
    ...
    $('.m-box').each(function () {
        ...
        if (k < 2) {
            ...
            $(this).parent().find('http://www.bossfq.com/mobile_files/.prev,.next').hide();
            $(this).parent().siblings('http://www.bossfq.com/mobile_files/.prev,.next').hide();
